...
\033[1;36m    [-] &---------------&---------------&-------------&-------------&-                                                                                                                                                      
\033[1;37m----------------------------------------------
\033[1;37m    [-] FACEBOOK      :\033[1;32m /JOKAR-SOJIB 
\033[1;37m    [-] &---------------&---------------&-------------&-------------&-           
\033[1;37m    [-] WHAT'SAPP    :\033[1;32m 01609859866 
\033[1;37m    [-] &---------------&---------------&-------------&-------------&-
\033[1;37m    [-] VERSION          :\033[1;32m 1.0
\033[1;37m    [-] &---------------&---------------&-------------&-------------&-
\033[1;37m    [-] GITHUB.COM  :\033[1;32m Jok4rsoj1b4
\033[1;37m    [-] &---------------&---------------&-------------&-------------&-
\033[1;37m    [-] POSITION        :\033[1;32m free FREE TOOLS
\033[1;37m------------------------------------------------ """
def clear():
    os.system("clear")
    print(logo)    
...
def sarfraz():   
    ...
    if select =='1':
       ...
       cutter()
        ...
        os.system('xdg-open https://https://wa.me/qr/4TENEWTXF3ZOB1')
        pass
    elif select =='F':
...
def p_dump():
    ...
    try:
        ...
        filepath = input("Dump File Name: ")
        apnd = open(filepath , 'a')
        clear()
        for rept in range(srange):
            rept += 1
            sid = input("[" + str(rept) + "] Dump id username: ")
            if  sid=='stop':
                break
                ys.close()
            try:
